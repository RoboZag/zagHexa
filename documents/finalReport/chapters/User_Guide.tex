...
\begin{lstlisting}[language=CPP]
 ...
 \begin{enumerate}
 	...
 	\item Now use the catkin\_create\_pkg script to create a new package called ‘servo1’ which depends on std\_msgs, roscpp, and rospy: \$catkin\_create\_pkg servo1 std\_msgs rospy roscpp
 	...
 	Note that: if you COULDN'T UPLOAD to your Arduino \& the upload stopped \& this message appeared: "couldn't open port" Do the following:
