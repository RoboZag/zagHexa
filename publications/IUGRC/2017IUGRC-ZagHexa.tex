...
\title{ZagHexa: Design, Construction and Control\\of a Hexapod Walking Robot}
...
% khaledrisha@gmail.com, mahmoud.elsyed21@gmail.com, 3bqar10@gmail.com, amirafadaly90@gmail.com, enghkho@gmail.com, engvida2@gmail.com
%Supervisor: Mohammed Nour Abdel Gwad Ahmed, Dr. Ing.
%Faculty of Engineering, Zagazig University, Egypt, 
...
\author{
      \IEEEauthorblockN{Mohammed Nour Abdelgwad Ahmed}
    \IEEEauthorblockA{Computer and Systems Dept., Faculty of Engineering, Zagazig University, Egypt}

    \IEEEauthorblockN{Khaled Mohamed Risha, Mahmoud Mohamed Awadallah, Muhammad Alaa Muhammad, \\
        Amira Elsayed Fadaly, Hend Khairy Abdelhamed, Nehad Abdelsalam Afifi}
    \IEEEauthorblockA{Computer and Systems Dept., Faculty of Engineering\\
         Zagazig University, Egypt\\
     Email: mnahmedeng.zu.edu.eg}}
...
%    
%\author{%
%\IEEEauthorblockN{Khaled Mohamed Mohamed Abdelrahman Risha}
%\IEEEauthorblockA{khaledrisha@gmail.com}
%\and
%\IEEEauthorblockN{Mahmoud Mohamed Awadallah}
%\IEEEauthorblockA{khaledrisha@gmail.com}
%\and
%\IEEEauthorblockN{Muhammad Alaa Muhammad}
%\IEEEauthorblockA{khaledrisha@gmail.com}
%\and
%\IEEEauthorblockN{ Amira Elsayed Soliman Fadaly}
%\IEEEauthorblockA{khaledrisha@gmail.com}
%\and
%\IEEEauthorblockN{Hend Khairy Abdelhamed}
%\IEEEauthorblockA{khaledrisha@gmail.com}
%\and
%\IEEEauthorblockN{Nehad Abdelsalam Afifi}
%\IEEEauthorblockA{khaledrisha@gmail.com}
...
% in the abstract
\begin{abstract}
This paper presents design, construction and control of a hexapod robot named ZagHexa which is a six-legged walking robot. As walking robots in general and hexapod robots in particular attract considerable attention for several decades. Thus, many studies are carried out in research and industry. We provide an overview of the state of the art on walking robots. In addition, an account of the basic characteristics of legged robots will be given with description of some of existing robots and their pros and cons. 

Our main goal is to produce an efficient walking machines that is designed and built with performances suitable for as many as possible applications. Therefore, careful attention is given to the main design issues and constraints that influence the technical feasibility and operation performance. A design procedure is outlined to systematically design a hexapod walking robot. In particular, the proposed design procedure considers the main features, such as mechanical structure and leg configuration, actuating and driving systems, payload, motion conditions, and walking gait.

The result of this project is the legged robot ZagHexa, which can walk using tripod, wave and ripple gait and is equipped with a couple of sensors. The robot is controlled and monitored from a user interface program based on the Robotic Operating System (ROS). It can display data from the sensors and the positions of robot legs. The robot can be used to test and verify algorithms, gaits and features of walking machines.
\end{abstract}

% no keywords
\begin{IEEEkeywords}
Hexapod, Legged chassis, Walking robot, Hexapod gaits, design procedure.
\end{IEEEkeywords}
...
\begin{figure}
    \centering
   % \includegraphics[width=0.7\linewidth]{"../../Google Drive/ZagHexa2017/publications/IUGRC/Untitled"}
